...
@implementation FFcircle_infoModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFcircle_infoModel数据模型中:未找到key = %@",key);
	return nil;
}
...
@implementation FFrelate_collectionModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFrelate_collectionModel数据模型中:未找到key = %@",key);
	return nil;
}
...
@implementation FFcollection_infoModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFcollection_infoModel数据模型中:未找到key = %@",key);
	return nil;
}
...
@implementation FFitem_infoModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFitem_infoModel数据模型中:未找到key = %@",key);
	return nil;
}
...
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
	if ([key isEqualToString:@"relate_collection"]) {
		for (NSDictionary *dic in value) {
			FFrelate_collectionModel *model = [FFrelate_collectionModel new];
		...
		for (NSDictionary *dic in value) {
			FFitem_infoModel *model = [FFitem_infoModel new];
			[model setValuesForKeysWithDictionary:dic];
		...
		FFcircle_infoModel *model = [FFcircle_infoModel new];
		[model setValuesForKeysWithDictionary:value];
		self.circle_info = model;
	}
	else if ([key isEqualToString:@"collection_info"]) {
		FFcollection_infoModel *model = [FFcollection_infoModel new];
		[model setValuesForKeysWithDictionary:value];
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFcollectionModel数据模型中:未找到key = %@",key);
	return nil;
}
...
@implementation FFitem_listModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFitem_listModel数据模型中:未找到key = %@",key);
	return nil;
}
...
@implementation FFbanner_listModel
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFbanner_listModel数据模型中:未找到key = %@",key);
	return nil;
}
...
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
	if ([key isEqualToString:@"item_list"]) {
		for (NSDictionary *dic in value) {
			FFitem_listModel *model = [FFitem_listModel new];
			[model setValuesForKeysWithDictionary:dic];
		...
		for (NSDictionary *dic in value) {
			FFbanner_listModel *model = [FFbanner_listModel new];
			[model setValuesForKeysWithDictionary:dic];
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFtopModel数据模型中:未找到key = %@",key);
	return nil;
}
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFdailyModel数据模型中:未找到key = %@",key);
	return nil;
}
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFcircleModel数据模型中:未找到key = %@",key);
	return nil;
}
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFfindModel数据模型中:未找到key = %@",key);
	return nil;
}
...
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
	if ([key isEqualToString:@"find"]) {
		for (NSDictionary *dic in value) {
			FFfindModel *model = [FFfindModel new];
			[model setValuesForKeysWithDictionary:dic];
			[self.Myfind addObject:model];
		}
	}
	else if ([key isEqualToString:@"circle"]) {
		FFcircleModel *model = [FFcircleModel new];
		[model setValuesForKeysWithDictionary:value];
		self.circle = model;
	}
}
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFthemeModel数据模型中:未找到key = %@",key);
	return nil;
}
...
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
	if ([key isEqualToString:@"collection"]) {
		FFcollectionModel *model = [FFcollectionModel new];
		[model setValuesForKeysWithDictionary:value];
		self.collection = model;
	}
	else if ([key isEqualToString:@"top"]) {
		FFtopModel *model = [FFtopModel new];
		[model setValuesForKeysWithDictionary:value];
		self.top = model;
	}
	else if ([key isEqualToString:@"daily"]) {
		FFdailyModel *model = [FFdailyModel new];
		[model setValuesForKeysWithDictionary:value];
		self.daily = model;
	}
	else if ([key isEqualToString:@"theme"]) {
		FFthemeModel *model = [FFthemeModel new];
		[model setValuesForKeysWithDictionary:value];
		self.theme = model;
	}
}
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFdataModel数据模型中:未找到key = %@",key);
	return nil;
}
...
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
	if ([key isEqualToString:@"data"]) {
		for (NSDictionary *dic in value) {
			FFdataModel *model = [FFdataModel new];
			[model setValuesForKeysWithDictionary:dic];
...
-(id)valueForUndefinedKey:(NSString *)key{
	NSLog(@"error: FFModel数据模型中:未找到key = %@",key);
	return nil;
}
