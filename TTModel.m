...
@implementation TTcircle_infoModel
...
@implementation TTrelate_collectionModel
...
@implementation TTcollection_infoModel
...
@implementation TTitem_infoModel
...
@implementation TTcollectionModel

+(JSONKeyMapper *)keyMapper{
	return [[JSONKeyMapper alloc] initWithDictionary:@{@"relate_collection":@"Myrelate_collection",@"item_info":@"Myitem_info",@"circle_info":@"Mycircle_info",@"collection_info":@"Mycollection_info"}];
}
...
@implementation TTitem_listModel
...
@implementation TTbanner_listModel
...
@implementation TTtopModel

+(JSONKeyMapper *)keyMapper{
	return [[JSONKeyMapper alloc] initWithDictionary:@{@"item_list":@"Myitem_list",@"banner_list":@"Mybanner_list"}];
}
...
@implementation TTthemeModel

+(JSONKeyMapper *)keyMapper{
	return [[JSONKeyMapper alloc] initWithDictionary:@{@"find":@"Myfind",@"circle":@"Mycircle"}];
}
...
+(JSONKeyMapper *)keyMapper{
	return [[JSONKeyMapper alloc] initWithDictionary:@{@"collection":@"Mycollection",@"top":@"Mytop",@"daily":@"Mydaily",@"theme":@"Mytheme"}];
}
...
+(JSONKeyMapper *)keyMapper{
	return [[JSONKeyMapper alloc] initWithDictionary:@{@"data":@"Mydata"}];
}
